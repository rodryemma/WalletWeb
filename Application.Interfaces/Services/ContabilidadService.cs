...
namespace Application.Services
{
    public class ContabilidadService : IContabilidadService
    {
        ...
        public async Task<OperationResult<List<ContabilidadDto>>> ObtenerContabilidadJoinDBFullAsyncService(string xTipo, DateTime xFechaDesde, string xMoneda = "USD")
        {
            var contabilidadMovimientos = await _ContabilidadRepository.ObtenerContabilidadJoinDBFullAsync(xTipo, xFechaDesde);
            if (!contabilidadMovimientos.Success) { return OperationResult<List<ContabilidadDto>>.Fail(contabilidadMovimientos.Message); }
