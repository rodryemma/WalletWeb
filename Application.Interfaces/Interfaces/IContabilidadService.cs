...
namespace Application.Interfaces
{
    public interface IContabilidadService
    {
        ...
        Task<OperationResult<List<ContabilidadDto>>> ObtenerContabilidadJoinDBFullAsyncService(string xTipo, DateTime xFechaDesde, string xMoneda);
        Task<OperationResult<List<ContabilidadDto>>> ObtenerContabilidadJoinDBFullAsyncService(string xTipo, DateTime xFechaDesde, DateTime xFechaHasta, string xMoneda);
